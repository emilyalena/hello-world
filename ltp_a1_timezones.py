...
def get_minutes(seconds_since_midnight):
    ...
    20
    '''
    return (seconds_since_midnight - (get_hours(seconds_since_midnight)*3600)) // 60
...
def get_seconds(seconds_since_midnight):
    ...
    15
    '''
    return (seconds_since_midnight - (get_hours(seconds_since_midnight)*3600) - (get_minutes(seconds_since_midnight)*60))
